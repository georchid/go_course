...
// дефолтный клиент = смэрть если сторонний сервис отваливается тк отсутствует возможность задать тайм ауты
// вывод - используй транспорт
